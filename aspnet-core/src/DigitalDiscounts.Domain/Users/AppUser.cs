...
namespace DigitalDiscounts.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update DigitalDiscountsDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update DigitalDiscountsEfCoreEntityExtensionMappings to extend the IdentityUser entity
